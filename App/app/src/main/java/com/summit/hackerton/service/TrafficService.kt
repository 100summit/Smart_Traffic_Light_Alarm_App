...
class TrafficService : Service() {
    private val mGeofenceManager: GeoFenceManager by lazy {
        GeoFenceManager()
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        mGeofenceManager.init(this, TrafficLightInfo.getGeofenceListTrafficLight())
    ...
    override fun onDestroy() {
        ...
        mGeofenceManager.removeGeofence()
